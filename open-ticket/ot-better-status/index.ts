...
//DISABLE FUSES (disables the default status behaviour from config/general.json)
opendiscord.sharedFuses.setFuse("clientActivityLoading",false)
opendiscord.sharedFuses.setFuse("clientActivityInitiating",false)
