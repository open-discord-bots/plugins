...
import { TwitchSubscription } from "./storage.js";
...
export const registerWatchButtonBuilder = (buttons:api.ODMappedButtonManager) => {
...
export const registerListPaginationButtonBuilders = (buttons: api.ODMappedButtonManager) => {
