...
import { TwitchODManager } from "./src/TwitchODManager.js";
import { getTwitchStorage } from "./src/storage.js";
import { registerWatchButtonBuilder, registerListPaginationButtonBuilders, TWITCH_LIST_FIRST_ID, TWITCH_LIST_PREV_ID, TWITCH_LIST_PAGE_ID, TWITCH_LIST_NEXT_ID, TWITCH_LIST_LAST_ID, buildListEmbed, buildResponseMessage} from "./src/embeds.js";
import { handleAddChannel, handleRemoveChannel, handleListChannels, handleEnableRegisters, handleDisableRegisters } from "./src/commands/index.js";
import { registerConfigChecker } from "./src/checker.js";

// Compatible with OpenDiscord/OpenTicket
interface OTTwitchNotifierConfigCustomResponse {
    color:string,
    title:string,
    description:string,
}
class OTTwitchNotifierConfig extends api.ODJsonConfig<{
    credentials:{
        useEnv:boolean,
    ...
    embeds:{
        live:{
            ...
            showViewersField:boolean,
            showStartField:boolean,
            gameFieldName:string,
            viewersFieldName:string,
    ...
    responses:{
        noPermission:OTTwitchNotifierConfigCustomResponse,
        notInGuild:OTTwitchNotifierConfigCustomResponse,
        configMissing:OTTwitchNotifierConfigCustomResponse,
        storageMissing:OTTwitchNotifierConfigCustomResponse,
        alreadyExists:OTTwitchNotifierConfigCustomResponse,
        added:OTTwitchNotifierConfigCustomResponse,
        removedOne:OTTwitchNotifierConfigCustomResponse,
        removedAll:OTTwitchNotifierConfigCustomResponse,
        listEmpty:OTTwitchNotifierConfigCustomResponse,
        streamerNotFound:OTTwitchNotifierConfigCustomResponse,
        apiError:OTTwitchNotifierConfigCustomResponse,
        limitReached:OTTwitchNotifierConfigCustomResponse,
        invalidChannel:OTTwitchNotifierConfigCustomResponse,
        registersEnabled:OTTwitchNotifierConfigCustomResponse,
        registersDisabled:OTTwitchNotifierConfigCustomResponse,
        registersNotEnabled:OTTwitchNotifierConfigCustomResponse,
        unknownSub:OTTwitchNotifierConfigCustomResponse
    },
    logMessages:{
        channelDeleted:OTTwitchNotifierConfigCustomResponse,
        streamerRenamed:OTTwitchNotifierConfigCustomResponse
    }
}> {}
declare module "#opendiscord-types" {
    interface ODPluginClassManagerIdMappings {
        "ot-twitch-notifier:manager": TwitchODManager;
    }
    interface ODPluginManagerIdMappings {
        "ot-twitch-notifier": api.ODPlugin;
    }
    interface ODConfigManagerIdMappings {
        "ot-twitch-notifier:config": OTTwitchNotifierConfig
    }
    interface ODSlashCommandManagerIdMappings {
        "ot-twitch-notifier:twitch": api.ODSlashCommand;
    }
    interface ODCommandResponderManagerIdMappings {
        "ot-twitch-notifier:twitch": {origin:"slash"|"text"; params: {}; workers: "ot-twitch-notifier:cmd" };
    }
}
...
opendiscord.events.get("onPluginClassLoad").listen((classes) => {
    if (!classes.get("ot-twitch-notifier:manager")) {
...
opendiscord.events.get("onCommandResponderLoad").listen((commands) => {
    ...
    //PERMISSION WORKER
    workers.push(
        new api.ODWorker("ot-twitch-notifier:perm", 1, async (instance, params, origin, cancel) => {
    ...
    //MAIN COMMAND WORKER
    workers.push(
        new api.ODWorker("ot-twitch-notifier:cmd", 0, async (instance, params, origin, cancel) => {
